...
public class Frame {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        mc.textRenderer.drawWithShadow(matrices, "Jungleware0.2.2", 0, 0, new Color(logo.red.getValueInt(), logo.green.getValueInt(), logo.blue.getValueInt(), logo.alpha.getValueInt()).getRGB());
