...
public class CheckBox extends Component {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        mc.textRenderer.drawWithShadow(matrices, boolSet.getName(), parent.parent.x + 2, parent.parent.y + parent.offset + offset + textOffset, new Color(0, 190, 0, 160).getRGB());
